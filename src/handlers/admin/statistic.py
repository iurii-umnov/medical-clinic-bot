            ...
            await bot.edit_message_text(
                ...
                text=BotMessageText.statistic(
                    ...
                    start_date=datetime.strftime(
                        datetime.strptime(start_date, DateFormat.system.value), DateFormat.output.value
                    ),
                    end_date=datetime.strftime(
                        datetime.strptime(end_date, DateFormat.system.value), DateFormat.output.value
                    )
                ),
                parse_mode='HTML',
                reply_markup=back_to_menu(section=CallbackData.statistics.value)
...
async def get_statistic(start_date: Union[str, datetime], end_date: Union[str, datetime],
                        start_date_prev: Union[str, datetime] = None, change: bool = False) -> Dict[Base, Any]:
    # annotation
    tables: Tuple[Base, Base, Base, Base]
    ...
    tables = (Appointment, Appointment, CallBack, Feedback)
