...
[//]: # (These are reference links used in the body of this note and get stripped out when the markdown processor does its job.)
  ...
  [src/core/secrets.py]: <https://github.com/iurii-umnov/medical-clinic-bot/blob/master/src/core/secrets.py>
  ...
  [src/handlers/admin/show_doctor.py]: <https://github.com/iurii-umnov/medical-clinic-bot/blob/master/src/handlers/admin/show_doctor.py>
  [src/handlers/admin/update_doctor.py]: <https://github.com/iurii-umnov/medical-clinic-bot/blob/master/src/handlers/admin/update_doctor.py>